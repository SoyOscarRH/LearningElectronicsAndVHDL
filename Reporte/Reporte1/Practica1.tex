...
\begin{titlepage}
    ...
    \rule{\linewidth}{0.5mm} \\[1.0cm]
        { \huge \bfseries Compuertas Básicas}\\[1.0cm] 
...
% ============    COMPUERTAS BASICAS         ==========
% =====================================================
\section{Compuertas Básicas}

    \subsection{AND}
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.85\textwidth]{Compuertas0}
            \caption{La posición especial de la compuerta AND}
        \end{figure}
    ...
    \subsection{OR}
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.85\textwidth]{Compuertas1}
            \caption{La posición especial de la compuerta OR}
        \end{figure}
    ...
    \subsection{NAND}
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.85\textwidth]{Compuertas2}
    ...
    \subsection{XOR}
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.85\textwidth]{Compuertas3}
            \caption{La posición especial de la compuerta XOR}
        \end{figure}
    ...
    \subsection{NOR}
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.85\textwidth]{Compuertas4}
            \caption{La posición especial de la compuerta NOR}
        \end{figure}
...
% ============    COMPUERTAS BASICAS         ==========
% =====================================================
\section{Compuertas Compuesta}

    \subsection{NAND Compuesta}
    
        Podemos ver gracias a la tabla de verdad que este circuito se
        comporta como una NAND
