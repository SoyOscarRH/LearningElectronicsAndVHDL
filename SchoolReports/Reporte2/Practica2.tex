...
\begin{titlepage}
    ...
    \rule{\linewidth}{0.5mm} \\[1.0cm]
        { \huge \bfseries Minimización Algebraíca}\\[1.0cm] 
...
% =====================================================
\section{Comparador de Magnitud}

    \subsection{Parte Teórica}

        \begin{figure}[h]
            \centering
            \includegraphics[width=0.60\textwidth]{Expansion0.jpg}
        \end{figure}
    ...
    \subsection{Parte Practica}
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=0.80\textwidth]{Circuit0.png}
        \end{figure}
...
% =====================================================
\clearpage
\section{De Código Binario a Código Grey}

    \subsection{Parte Teórica}

        \begin{figure}[h!]
            \centering
            \includegraphics[width=0.60\textwidth]{Expansion3.jpg}
        \end{figure}
    ...
    \subsection{Parte Practica}
        \begin{figure}[h!]
            \centering
            \includegraphics[width=0.80\textwidth]{Circuit1.png}
        \end{figure}
...
% =====================================================
\clearpage
\section{De Código BCD a 7 Segmentos}
    ...
    \subsection{Parte Teórica}
        ...
        \begin{figure}[h!]
            \centering
            \includegraphics[width=0.60\textwidth]{Expansion2.jpg}
        \end{figure}
    ...
    \subsection{Parte Practica}
        \begin{figure}[h!]
            \centering
            \includegraphics[width=0.80\textwidth]{Circuit2.png}
        \end{figure}
